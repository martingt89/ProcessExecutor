...
pkglibexecdir = $(libexecdir)/processexecutor-c--
...
PACKAGE_STRING = ProcessExecutor C++ 0.1
PACKAGE_TARNAME = processexecutor-c--
PACKAGE_URL = 
PACKAGE_VERSION = 0.1
PATH_SEPARATOR = :
SET_MAKE = 
...
install_sh = ${SHELL} /home/martint/ProcessExecutor/install-sh
